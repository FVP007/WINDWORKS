    ...
    public partial class Form1 : Form
    {
        ...
        private void LoadVRMLModel(object sender, EventArgs e)
        {
            try
            {
                ...
                string scenePath = "C:\\Users\\felip\\Downloads\\TCC_2025\\Vrml\\cena.wrl";
        ...
        private void UpdateVRMLFile(string airplaneType, int windSpeed)
        {
            try
            {
                string vrmlPath = "C:\\Users\\felip\\Downloads\\TCC_2025\\Vrml\\cena.wrl";
            ...
            string html = @"<!DOCTYPE html>
                        ...
                        <body>
                            <div class='chart-header'>
                                ...
                                <div class='chart-subtitle'>Density: " + density.ToString("F2") + @" kg/m³ | Area: " + area.ToString("F2") + @" m² | Coefficient: " + coefficient.ToString("F2") + @"</div>
                            </div>
        ...
        {
            string basePath = @"C:\Users\felip\Downloads\TCC_2025\Prints";
